...
data = pd.read_csv("02-data-cleaning/merged_dataframe.csv",
                   dtype={"mjoPENTAD": float, "mjo20E": float, "mjo80E": float, "mjo100E": float, "mjo120E": float,
                          ...
                          "ninoNINO3.4": float, "ninoANOM.3": float, "oniSEAS": object, "oniTOTAL": float,
                          "oniANOM": float, "pdo": float, "pna": float, "soi_anom": float, "soi_sd": float,
                          "site_id": object, "forecast_year": float, "volume": float})
